		...
		<div>
			...
			<div class="px-5 py-4 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 text-sm">
				...
				<a
					...
					href="/dokter/monitoring/{ monit.code }/edit"
				>
					Edit Form
				</a>
				...
				<button
					...
					on:click|preventDefault={deleteMonit}
				>
					Hapus Form
				</button>
			</div>
				...
				{#if monit.participants}
					...
					{#if monit.participants.length > 0}
						{#each monit.participants as patient}
							<div class="flex justify-between items-center mt-4">
								<a href="/dokter/pasien/{ patient }" class="font-semibold">{ patient }</a>
								<!-- <svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-4 w-4 ml-1"
									fill="none"
