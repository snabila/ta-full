...
<div in:fade={{delay: 500, duration: 500}} out:fade|local={{duration: 500}}>
	...
	<div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
		...
		>
			...
			<div>
				<a href="/dokter/monitoring"><p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Monitoring Form</p></a>
		...
		>
			...
			<div>
				<a href="/dokter/pasien"><p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pasien Monitoring</p></a>
		...
		>
			...
			<div>
				<a href="/dokter/responds"><p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Respon</p></a>
					...
					<tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
						...
						<tr class="text-gray-700 dark:text-gray-400">
							<td class="px-4 py-3 text-sm">
								<a href="/dokter/pasien/{ record.user }"><p class="font-semibold">{ record.user }</p></a>
							</td>
